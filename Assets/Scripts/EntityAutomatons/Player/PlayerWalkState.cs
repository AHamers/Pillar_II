...
public class PlayerWalkState : EntityState
{
    ...
    public override EntityState checkTransition()
    {
        ...
        else if(Input.GetKeyDown(Globals.singleton.sprint))
        {
    ...
    public override void fixedUpdateState()
    {
        ...
        cc.SimpleMove(player.transform.forward * Globals.singleton.playerWalkSpeed * Time.deltaTime);
    }

    public override void onEnterState()
    {
        Globals.singleton.player.GetComponent<Animator>().SetInteger("PlayerState", (int)EntityAnimationState.WALKING);
    }

    public override void onExitState()
    {
        Globals.singleton.player.GetComponent<CameraAutomaton>().currentPlayerAngleOffset = 0;
    }
